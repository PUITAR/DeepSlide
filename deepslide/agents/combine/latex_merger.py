...
#     # Please modify the following three variables according to your project configuration
    
#     # 1. Your project root directory (usually the folder containing the main .tex file)
#     PROJECT_ROOT = '.' 
    
#     # 2. Your main .tex filename
#     MAIN_FILE_NAME = 'main.tex' 
    
#     # 3. Output new filename
#     OUTPUT_FILE_NAME = 'output_merged.tex'
    
#     try:
#         print(f"🚀 Start merging project: {MAIN_FILE_NAME}")
        
#         # Start recursive merge process
...
#         print("-" * 30)
#         print(f"🎉 Congratulations! File successfully merged to: {output_path}")

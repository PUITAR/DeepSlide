...
STEP1_5_PROMPT_PATH = str(BASE_DIR / "html_diedai" / "step1_5_planner_prompt_v14_images_keynote_uifix.txt")

# --- Step2 prompts: dynamic shell + per-slide (avoid truncation)
STEP2_SHELL_PROMPT_PATH = str(BASE_DIR / "html_diedai" / "step2_shell_prompt_v4_css_only_keynote_uifix.txt")
STEP2_SLIDE_PROMPT_PATH = str(BASE_DIR / "html_diedai" / "step2_slide_prompt_v2_dynamic_per_slide_keynote_uifix.txt")

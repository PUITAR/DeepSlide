...
from deepslide.utils.chapter_node import ChapterNode, NodeType
from deepslide.utils.rough_divider import RoughDivider
...
"""
    ...
    def divide(self, tex_path: str, schema: Optional[List[str]] = None) -> List[ChapterNode]:
        """
        Divide LaTeX content into a tree of sections and knowledge objects.
        Returns a list of ChapterNode objects (all nodes, flattened list but linked via children_ids).
        """
        try:

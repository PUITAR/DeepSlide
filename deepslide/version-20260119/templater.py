...
class Templater:
    ...
    def modify(self, base_dir: str, user_need: str) -> Dict[str, str]:
        ...
        sys = (
            ...
            "NOTE: "
            "1. Do not modify the document class or any essential settings. e.g."
            "   introducing unnecessary line breaks such as '\\\\'"
            "2. Do not modify the content of title.tex, content.tex, or ref.tex."
            "3. Do not remove any existing packages or settings."
        )
